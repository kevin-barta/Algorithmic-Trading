   ...
   for(int i=iCurrent-IndicatorPeriod-1; i>0; i--)
     {
      ...
      outputData+=","+ DoubleToString(iOpen(Symbol(),PERIOD_CURRENT,i));
      outputData+=","+ DoubleToString(iClose(Symbol(),PERIOD_CURRENT,i));
      outputData+=","+ DoubleToString(iHigh(Symbol(),PERIOD_CURRENT,i));
      outputData+=","+ DoubleToString(iLow(Symbol(),PERIOD_CURRENT,i));
      outputData+=","+ DoubleToString(iVolume(Symbol(),PERIOD_CURRENT,i));
      outputData+="\n";
