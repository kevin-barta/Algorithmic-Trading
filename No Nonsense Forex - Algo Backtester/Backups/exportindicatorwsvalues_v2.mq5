...
//input int    IndicatorPeriod=14;                                                                                         //EDITED
input string Indicator_Directory_And_Name="Examples\\ATR";
//+------------------------------------------------------------------+
...
// Prepare file name, e.g: EURUSD_PERIOD_H1(RSI,14)
   ...
   //string indicatorPeriod=IntegerToString(IndicatorPeriod);                                                              //EDITED
   //StringConcatenate(ExtFileName,sSymbol,"_",sPeriod,"(",indicatorName,",",indicatorPeriod,")",".CSV");                  //EDITED
   StringConcatenate(ExtFileName,sSymbol,"_",sPeriod,"(",indicatorName,")",".CSV");                    //EDITED
   ...
   //int rsiHandle=iCustom(sSymbol,PERIOD_CURRENT,Indicator_Directory_And_Name,IndicatorPeriod);       // Change here.     //EDITED
   int rsiHandle=iCustom(sSymbol,PERIOD_CURRENT,Indicator_Directory_And_Name);//,IndicatorPeriod);       // Change here.   //EDITED
