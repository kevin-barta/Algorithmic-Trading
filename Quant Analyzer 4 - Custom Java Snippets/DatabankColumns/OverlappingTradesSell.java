...
public class OverlappingTradesSell extends DatabankColumn {
    
	public OverlappingTradesSell() {
		super();
		
		setName(L.t("Overlapping Trades Sell"));		
		setTooltip(L.t("Overlapping Trades Sell"));
		setWidth(60);
	}
	...
	public Object getValue(SQResultsGroup strategyResults, String dataType, String direction, String sampleType, String plType) throws Exception {
		...
		return stats.getDouble("Overlapping_Trades_Sell");
	}
