...
public class OverlappingTrades extends DatabankColumn {
    
	public OverlappingTrades() {
		super();
		
		setName(L.t("Overlapping Trades"));		
		setTooltip(L.t("Overlapping Trades"));
		setWidth(60);
	}
	...
	public Object getValue(SQResultsGroup strategyResults, String dataType, String direction, String sampleType, String plType) throws Exception {
		...
		return stats.getDouble("Overlapping_Trades");
	}
