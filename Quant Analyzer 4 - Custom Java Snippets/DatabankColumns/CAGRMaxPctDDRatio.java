...
public class CAGRMaxPctDDRatio extends DatabankColumn {
    
	public CAGRMaxPctDDRatio() {
		super();
		
		setName(L.t("CAGR/Max%DD Ratio"));		
		setTooltip(L.t("CAGR/Max%DD Ratio"));
		setWidth(60);
	}
	...
	public Object getValue(SQResultsGroup strategyResults, String dataType, String direction, String sampleType, String plType) throws Exception {
      ...
      return stats.getDouble("CAGR_MaxPctDD_Ratio", 0);
	}
