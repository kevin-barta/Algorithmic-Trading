...
public class RollingMaxDrawdown extends DatabankColumn {
    
	// Rolling Window in days
	static final int rollingWindow = 30;

	public RollingMaxDrawdown() {
		super(L.tsq("Rolling " + rollingWindow + "D Max Drawdown"), DatabankColumn.Decimal2PL, ValueTypes.Minimize, 0, 0, 10000);
	...
	public double compute(SQStats stats, StatsTypeCombination combination, OrdersList ordersList, SettingsMap settings, SQStats statsLong, SQStats statsShort) throws Exception {
		...
		for(int i=0; i<ordersList.size(); i++) {
			...
			if((o.AccountBalance - o.PL) - oLowestBalance > maxDD){
				maxDD = (o.AccountBalance - o.PL) - oLowestBalance;
